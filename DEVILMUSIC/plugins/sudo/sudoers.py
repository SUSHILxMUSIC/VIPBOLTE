...
from DEVILMUSIC.music import SUDOERS
from DEVILMUSIC.utils.database import add_sudo, remove_sudo
from DEVILMUSIC.utils.decorators.language import language
from DEVILMUSIC.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_video(video="https://telegra.ph/file/a088303b636ff3c2d474a.mp4", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
